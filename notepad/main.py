...
# 9)also convert in exe file
# messagebox for popu dialog box
# accelerator for shortcut key
# tearoff->file menu comes out
# create checkbox type with onvalue off value
# and compound use to telll which side place img
# in color_deict->textcolor,bg color
# bydefault->arial
 

# scroolbar.config and texteditor.config=>to connect both
...
main_application.geometry("1200x735")
