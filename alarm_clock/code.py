#colspan->how many columns it merges
from tkinter import *
...
def a():
	...
	if a == "":
		...
		if Alarmtime == CurrentTime:
			...
			mixer.music.play()
			x=amsg.get()
			msg = messagebox.showinfo('It is time',f'{x}')
			if msg == 'ok':
				mixer.music.stop()
...
head =Label(root,text="ALARM CLOCK",font=('comic sans',20,'bold'),bg = '#c6ffc1')
head.pack(fill=X,pady=15)

panel = Frame(root,bg = '#c6ffc1')
