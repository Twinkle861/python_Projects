# #typing speed game->
# +400and +100 in geometry to get in center
# change icon->download .ico image
# then root.iconbitmap(path of icon)

# justify=center to type from center,focus set so that type directly dont need to click in box
# labelslider func to slide text at top
# .after(1,func)
# call that after 1ms
# to bind enter return keyword when press enetr call start game
# shuffle the list on each enter
# rr=true when click on retry

# download setup file and then in cmd python nameofsetupfile.py bdist_mi
# in setup file change
# iclude files,target,version,name.executabels
